<!-- Debut Footer -->
<footer>
    <div class="container container-legal-notice d-flex justify-content-center">
        <div class="i-legal-notice">
            <a href="#" class="legal-notice" data-toggle="modal" data-target="#conditions">Conditions D'utilisation</a>
            <a href="#" class="legal-notice" data-toggle="modal" data-target="#policy">Politique de Confidentialité</a>
            <a href="#" class="legal-notice" data-toggle="modal" data-target="#return">Politique de retour</a>
            <a href="#" class="legal-notice" data-toggle="modal" data-target="#cookies">Politique des Cookies</a>
        </div>
    </div>
</footer>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="returnTitle">Politique de Confidentialité</h5>
            ...
            <div class="modal-body">
                <p>
                    ...
                    * Tout article qui est retourné plus de 30 jours après la livraison.
                    ...
                    Expédition
                    Pour retourner un produit, vous devez l’envoyer par la poste à: 6 rue de l'espace, Amiens, S, 80000, France.
                    ...
                    Si vous expédiez un article d’une valeur supérieure à 100€ vous devriez envisager d’utiliser un service de livraison qui vous permet de suivre l’envoi ou de souscrire à une assurance de livraison. Nous ne garantissons pas que nous recevrons l’article que vous nous retournez.
                </p>
            </div>
...
<div class="modal fade" id="policy" tabindex="-1" role="dialog" aria-labelledby="policyTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="policyTitle">Politique de Confidentialité</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>
                    ...
                    Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à daoz3@wimsg.com ou par courrier à: Vin'loud 6 rue de l'espace, Amiens, S, 80000, France
...
<!-- Modal des Conditions de vente-->
<div class="modal fade" id="conditions" tabindex="-1" role="dialog" aria-labelledby="conditionsTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="conditionsTitle">Conditions D'utilisation</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>
                    ...
                    Ces Conditions Générales de Vente et d’Utilisation, ainsi que tout autre accord séparé par le biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en vigueur à 6 rue de l'espace, Amiens, S, 80000, France.
...
<div class="modal fade" id="cookies" tabindex="-1" role="dialog" aria-labelledby="cookiesTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cookiesTitle">Politique de cookies</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>
                    ...
                    Si nous vous demandons de nous fournir vos renseignements personnels pour une autre raison, à des fins de marketing par exemple, nous vous demanderons directement votre consentement explicite, ou nous vous donnerons la possibilité de refuser.
                    Comment puis-je retirer mon consentement?
                    Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à 9gdpg@wimsg.com ou par courrier à: Vin'loud 6 rue de l'espace, Amiens, S, 80000, France
                    ARTICLE 3 – DIVULGATION
                    Nous pouvons divulguer vos renseignements personnels si la loi nous oblige à le faire ou si vous violez nos Conditions Générales de Vente et d’Utilisation.
                    ARTICLE 5 – SERVICES FOURNIS PAR DES TIERS
                    De manière générale, les fournisseurs tiers que nous utilisons vont uniquement recueillir, utiliser et divulguer vos renseignements dans la mesure du nécessaire pour pouvoir réaliser les services qu’ils nous fournissent.
                    ...
                    Si notre boutique fait l’objet d’une acquisition par ou d’une fusion avec une autre entreprise, vos renseignements pourraient être transférés aux nouveaux propriétaires pour que nous puissions continuer à vous vendre des produits.
                    QUESTIONS ET COORDONNÉES
                    Si vous souhaitez: accéder à, corriger, modifier ou supprimer toute information personnelle que nous avons à votre sujet, déposer une plainte, ou si vous souhaitez simplement avoir plus d’informations, contactez notre agent responsable des normes de confidentialité à 9gdpg@wimsg.com ou par courrier à Vin'loud
                    [Re: Agent des Normes de Confidentialité]
                    [6 rue de l'espace, Amiens, S, 80000, France]
                </p>
            </div>
...
<script src="/assets/js/connectionModal.js"></script>
